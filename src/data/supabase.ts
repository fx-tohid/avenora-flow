...
// createClient throws on an empty URL, which would crash the app at launch
// (e.g. EAS builds, where the gitignored .env isn't present). Fall back to a
// placeholder so solo play still works; Teams requests will just fail.
